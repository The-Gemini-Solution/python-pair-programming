...
class ToRomanBadInput(unittest.TestCase):
    ...
    def test_zero(self):
        '''
        to_roman should fail with OutOfRangeError for 0 input
        '''
...
class FromRomanBadInput(unittest.TestCase):
    ...
    def test_blank(self):
        '''
        from_roman should fail with InvalidRomanNumeralError with blank string
        '''
        raise NotImplementedError

    def test_non_string(self):
        '''
        from_roman should fail with InvalidRomanNumeralError non-string input
        '''
        raise NotImplementedError
